...
using ColorChessConsole.Model.BuildSystem.Builders;
using ColorChessConsole.Model.GameState;
using ColorChessConsole.Model.GameStateCalcSystem;

namespace ColorChessConsole.Model.BuildSystem
{
    ...
    public class GameStateBuilder
    {
        ...
        public Map CreateGameState()
        {
            ...
            GameStateCalcSystem.GameStateCalcSystem.UpdateGameStateForBuilder(gameState);
