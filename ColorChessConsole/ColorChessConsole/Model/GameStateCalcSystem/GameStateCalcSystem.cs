...
using ColorChessConsole.Model.WayCalcSystem.Algorithms;

namespace ColorChessConsole.Model.GameStateCalcSystem
{
    class GameStateCalcSystem
    {
        ...
        public static Map ApplyStep(Map _gameState, Figure figure, Cell endCell)
        {
            ...
            List<Cell> Way = WayCalcSystem.WayCalcSystem.CalcWay(gameState, newFigure.pos, endCell.pos, newFigure);
